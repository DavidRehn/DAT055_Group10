...
insert into Messages values ('B', 3, 'a', 'text', 'Hi!');
insert into Messages values ('B', 4, 'a', 'text', 'Hi!');
insert into Messages values ('B', 5, 'a', 'text', 'Hi!');
insert into Messages values ('B', 6, 'a', 'text', 'Hi!');
insert into Messages values ('B', 7, 'a', 'text', 'Hi!');
insert into Messages values ('B', 8, 'a', 'text', 'Hi!');
insert into Messages values ('B', 9, 'a', 'text', 'Hi!');
insert into Messages values ('B', 10, 'a', 'text', 'Hi!');
insert into Messages values ('B', 11, 'a', 'text', 'Hi!');
insert into Messages values ('B', 12, 'a', 'text', 'Hi!');
insert into Messages values ('B', 13, 'a', 'text', 'Hi!');
insert into Messages values ('B', 14, 'a', 'text', 'Hi!');
